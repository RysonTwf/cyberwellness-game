...
A **final recap experience**, played after all 3 terms of the Cyber Wellness curriculum are done, mostly self-directed over the holidays, sometimes teacher-led in class. Not a term-by-term companion, so it does not need to mirror Term 1→2→3 chronology. It needs to **comprehensively touch everything taught across the year**, in a single ~20–30 min sitting, ordered for narrative pacing rather than calendar order.

**Decision:** **One game, one app, one entry point.** The Atlas Gate asks the student whether they are P1–P3 or P4–P6, then the app shows that band's content for the rest of the session. The *content* is fully separate per band, different scenarios throughout, and different mechanics for 2 of the 5 realms, not just a difficulty toggle, but it is delivered as a single product, not two separately built/deployed apps sharing only visuals and characters.
...
| Be Smart Online | Not everything is true, check sources; **posts stay online forever**; **respect others' work, do not copy/steal** | Fake News realm (sources) ✅ · **digital footprint, gap** ⚠️ · **plagiarism/IP, gap (minor)** ⚠️ |
...
- **Bottom line:** our plan's band differentiation, harder mechanics, more nuanced scenarios, different "stakes" for P4–P6, is **our own design extension for making a good recap game**, not something the curriculum itself mandates. Nothing wrong with that, but it should not be presented as "the curriculum requires this" if it comes up in review, it is a deliberate enrichment layer on top of a mostly one-size-fits-all source.
...
- [x] Confirm how much weight "respect others' work" should get: fold into Fable Falls as planned, or skip entirely for v1? **Folded into Fable Falls, 1 Sep 2026** (verification pass against the Overview & Plan PDF). Light touch as §2 recommended: one quiz question per band (P1–P3 "you find a drawing you love, what do you do", P4–P6 "using a photo someone else took"), a closing line in each rule ("say whose work it is" / "credit them and ask first, it is theirs not yours to pass off"), and a 4th `intro.learn` bullet. No dedicated beat or realm.
...
- [x] **Confirm** the **5th Traveler's Pledge line** (Fable Falls). **Live in the certificate as of 18 Aug 2026**, *"I will stop and check before I believe or share."* Wording sign-off is still informally open (nobody's said no to it, but nobody's explicitly signed off either).
