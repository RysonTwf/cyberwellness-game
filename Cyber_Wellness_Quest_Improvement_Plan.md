...
- [ ] Confirm how much weight "respect others' work" should get: fold into Fable Falls as planned, or skip entirely for v1? **Not yet folded in**, Fable Falls' shipped content (18 Aug 2026) does not currently touch plagiarism/IP; still the lowest-priority gap from §2.
