...
## Corpus Check
- 43 files · ~41,667 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 255 nodes · 304 edges · 38 communities (15 shown, 23 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bc0ddbbe`
...
Cohesion: 0.14
Nodes (15): ChoiceCard(), DialogueCard(), PlatformerStoryRealm(), RealmArt(), EXTRA_BEAT_ORDER, GAMES, REALM_ICONS, ReportBlock() (+7 more)

### Community 3 - "Characters.jsx"
Cohesion: 0.18
Nodes (7): BRANCH_CTRL, GATE, GATE_SVG, ISLANDS, Boat(), Traveler(), World()
...
Cohesion: 0.21
Nodes (11): SPA Root Mount Point, App(), AtlasMap(), REALMS, ArtPreview(), MOODS, freshRealmProgress(), initialState() (+3 more)
...
- **Why does `World()` connect `Characters.jsx` to `RealmScreen.jsx`?**
