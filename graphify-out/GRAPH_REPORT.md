...
## Corpus Check
- 55 files · ~97,974 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 482 nodes · 662 edges · 103 communities (16 shown, 87 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 54 edges (avg confidence: 0.5)
...
- `BayStoryRealm()` --calls--> `makeOneMoreConfig()`  [EXTRACTED]
  src/components/BayStoryRealm.jsx → src/minigames/phaser-scenes/oneMoreScene.js
...
## Communities (103 total, 87 thin omitted)
...
Cohesion: 0.08
Nodes (30): BayStoryRealm(), ACTION_LABEL, BogStoryRealm(), KIND_LABEL, ChoiceCard(), DialogueCard(), ACTION_LABEL, KIND_LABEL (+22 more)
...
Cohesion: 0.13
Nodes (14): Files touched, Handover — Privacy Peaks rebuild (2026-08-20), Not done / next up, `src/components/PeaksStoryRealm.jsx` (new, ~480 lines), `src/components/RealmScreen.jsx`, `src/data/realms.js`, `src/minigames/phaser-scenes/fogLineScene.js` (new, ~740 lines), `src/minigames/phaser-scenes/peakArt.js` (new, ~610 lines) (+6 more)
