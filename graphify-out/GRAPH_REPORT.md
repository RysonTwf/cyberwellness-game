...
## Corpus Check
- 65 files · ~586,421 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 387 nodes · 688 edges · 36 communities (15 shown, 21 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 40 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ec8fff43`
...
Cohesion: 0.07
Nodes (23): AtlasGate(), DIARY_COPY, BY_NAME, CharacterArt(), Comet(), INTRO_BEATS, IntroStory(), ICONS (+15 more)

### Community 1 - "contentOverrides.js"
Cohesion: 0.12
Nodes (35): App(), bandViewRaw(), getBandView(), REALMS, applyOverrides(), clearOverrides(), collectEditable(), collectScreenEditable() (+27 more)
...
Cohesion: 0.16
Nodes (14): CharacterSelect(), OPTIONS, MainScreen(), RealmScreen(), SchoolLogo(), useUiClickSfx(), useUiHoverSfx(), getPool() (+6 more)
...
- **Why does `DialogueCard()` connect `RealmScreen.jsx` to `TravelerRoom.jsx`, `AtlasMap.jsx`, `realms.js`?**
